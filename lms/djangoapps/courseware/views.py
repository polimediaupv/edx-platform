...
def nivelacion(request):
    ...
    return render_to_response("courseware/nivelacion.html", {'courses': courses})

@ensure_csrf_cookie
@cache_if_anonymous()
def intartificialmaster(request):
    """
    Render "find courses" page.  The course selection work is done in courseware.courses.
    """
    courses = get_courses(request.user, request.META.get('HTTP_HOST'))
    ...
    return render_to_response("courseware/intartmaster.html", {'courses': courses})
