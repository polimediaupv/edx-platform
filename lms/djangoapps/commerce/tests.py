...
class PurchaseViewTests(ModuleStoreTestCase):
    """
    Tests for the commerce purchase view.
    """
    ...
    def _post_to_view(self, course_id=None):
        ...
        Arguments
            course_id (str) --  ID of course for which a seat should be purchased.
    ...
    def setUp(self):
        ...
        self.url = reverse('commerce:purchase')
    ...
    def test_course_with_sku(self, user_is_active):
        ...
        msg = 'Order {} was completed.'.format(ORDER_NUMBER)
    ...
    def test_order_not_complete(self):
        ...
        msg = u'Order {} was created, but is not yet complete. User was enrolled.'.format(ORDER_NUMBER)
        self.assertResponseMessage(response, msg)
    ...
    def test_course_without_sku(self):
        ...
        msg = 'The honor mode for {} does not have a SKU. Enrolling {} directly.'.format(
            self.course.id, self.user.username)
        self.assertResponseMessage(response, msg)
    ...
    def test_no_settings(self):
        ...
        self._mock_ecommerce_api()
        self.assertEqual(response.status_code, 200)
        msg = 'E-Commerce API not setup. Enrolled {} in {} directly.'.format(self.user.username, self.course.id)
        self.assertResponseMessage(response, msg)
